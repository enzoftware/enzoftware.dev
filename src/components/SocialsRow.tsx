...
export function SocialsRow({ t, socials }: SocialsRowProps) {
  return (
    <div className="flex items-center gap-2.5 flex-wrap" aria-label={t.title}>
      {socials.map((social, i) => (
        <motion.a
          ...
          title={social.label}
          className="flex items-center justify-center w-10 h-10 rounded-full border border-border text-ink-muted hover:text-accent hover:border-accent/50 hover:-translate-y-0.5 transition-all"
