...
export function SocialsRow({ t, name, socials }: SocialsRowProps) {
  return (
    <motion.section
      className="section-rhythm flex flex-col items-center text-center gap-7"
      ...
      <div className="flex items-center gap-3 flex-wrap justify-center">
        {socials.map((social, i) => (
          <motion.a
            ...
            title={social.label}
            className="flex items-center justify-center w-11 h-11 rounded-full border border-border text-ink-muted hover:text-accent hover:border-accent/40 hover:-translate-y-0.5 transition-all"
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
